...
**貨幣の硬度（Hardness）**とは、貨幣の新規生産がどれほど困難であるかを示す特性です。これを定量的に測定する指標が**Stock-to-Flow（S2F）**比率です。

{{< chart-bar title="ストック対フロー比率 (高いほど硬い貨幣)" labels="ビットコイン,金,銀,法定通貨" values="120,62,22,0" >}}
