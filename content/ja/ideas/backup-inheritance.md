---
title: "バックアップと相続計画 (Backup & Inheritance)"
description: "シードフレーズを安全に保管し、所有者の死亡・無能力時に資産を移転する戦略。ビットコイン自己主権の最後のパズル。"
tags: ["ビットコイン"]
levels: "上級"
weight: 40
---
...
|------|---------|-----------|
| **紙** | 簡単、無料 | 火災・浸水・退色に脆弱 |
| **スチールプレート** | 耐火・耐水・耐食 | コスト発生 |
| **デジタル（USB・クラウド）** | 複製が容易 | ハッキング・マルウェア露出リスク |
...
2. **情報分離の原則**：一人にすべての情報を渡さない
   ...
   - Bさんに：パスフレーズ
   - Cさんに：復旧手順ガイド
3. **[マルチシグ](/ideas/multisig/)の活用**：2-of-3設定で遺族2人が合意すれば資金移動可能
...
- [ビットコインウォレットガイド](/ideas/wallet-guide/) — ウォレット種類別のセキュリティ特性と選択ガイド
- [マルチシグ](/ideas/multisig/) — 複数署名で単一障害点を除去するセキュリティ
- [ノード](/ideas/node/) — 第三者なしに自分の取引を直接検証
