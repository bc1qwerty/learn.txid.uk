...
description: "A radical thinker who justified liberalism through argumentation ethics."
tags: ["Liberalism"]
weight: 7
---

## The Most Radical Voice of Liberalism
...
1. **The Presupposition of Self-Ownership**: To participate in argumentation means to freely use one's own body (brain, vocal cords, hands). If the other party had control over my body, I could not participate in argumentation.

2. **The Presupposition of Non-Aggression**: Argumentation is an activity aimed at persuading the other through **logic and evidence**, not through physical coercion. To justify force while simultaneously engaging in argumentation is a **performative contradiction**.

3. **The Presupposition of Private Property**: If we grant self-ownership, we logically derive the right to property in external resources transformed by one's labor (homesteading).
...
### Critique of Democracy: Why Democracy Is a Failed God
...
Hoppe extends time preference theory into a theory of civilization. **Low [time preference](/ideas/time-preference/)** — the tendency to forego present satisfaction for the future — enables saving, investment, and long-term planning, and is the foundation of civilizational development.

According to Hoppe, the state (particularly the democratic state) artificially **increases time preference**:

- Inflation destroys the value of savings, signaling to consume immediately
- High taxes reduce the rewards for future investment
- The welfare state allows present consumption without personal responsibility
- Public debt transfers costs to future generations
...
- **Dispute Resolution**: Provided competitively by private arbitration agencies
- **Public Order**: Provided by private security companies and insurance companies
- **Defense**: Armed citizens and private defense associations
- **Infrastructure**: Everything provided in markets based on private property
...
- *A Theory of Socialism and Capitalism* (1989) — systematic critique of various forms of socialism
- *The Economics and Ethics of Private Property* (1993)
- *Democracy: The God That Failed* (2001) — the representative work on the critique of democracy
- *The Great Fiction* (2012) — a collection of essays
...
- **Technological Reinforcement of Private Property**: Bitcoin's private keys represent mathematically guaranteed ownership and protect property from state seizure
- **Destruction of State Currency Monopoly**: Bitcoin technologically circumvents the state monetary monopoly that Hoppe critiques
- **Promotion of Low Time Preference**: Bitcoin's fixed supply encourages saving and eliminates inflation-induced distortions of time preference

## Related Concepts

- [Non-Aggression Principle](/ideas/non-aggression-principle/) — the core principle reached by argumentation ethics
- [Time Preference](/ideas/time-preference/) — a key concept in Hoppe's theory of civilization
- [What is Liberalism?](/start/libertarianism/) — political philosophy to which Hoppe has contributed
- [Sound Money](/ideas/sound-money/) — the relationship between time preference and currency