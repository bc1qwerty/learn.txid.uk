...
**화폐의 경도 (Hardness)**란 화폐의 신규 생산이 얼마나 어려운지를 나타내는 속성입니다. 이를 정량적으로 측정하는 지표가 **Stock-to-Flow(S2F)** 비율입니다.
...
{{< chart-bar title="Stock-to-Flow 비율 (높을수록 경도가 높음)" labels="비트코인,금,은,법정화폐" values="120,62,22,0" >}}

## 역사적 화폐들의 S2F 비교

역사를 통해 다양한 재화가 화폐로 사용되었으며, 그 경도의 차이가 문명의 흥망에 영향을 미쳤습니다.

- **조개, 유리구슬**: S2F가 매우 낮습니다. 아프리카에서 화폐로 사용되던 아그리 비즈(aggri beads)는 유럽인들이 대량 생산하여 가져왔을 때 가치가 급락했습니다. 이는 낮은 경도의 화폐가 가진 치명적 취약점을 보여줍니다.
- **구리**: S2F ≈ 3-5. 산업적으로 유용하지만 생산이 상대적으로 용이하여 화폐로서의 지속성이 약했습니다.
- **은**: S2F ≈ 22. 오랜 기간 화폐로 기능했으나, 금보다 낮은 경도 때문에 결국 금본위제에서 보조적 역할로 밀려났습니다.
- **금**: S2F ≈ 58-62. 수천 년간 축적된 재고가 방대하고 연간 신규 채굴량이 이에 비해 미미합니다. 이것이 금이 수천 년간 화폐의 왕좌를 유지한 핵심 이유입니다.
...
- **2009-2012**: 블록당 50 BTC 보상, S2F ≈ 1 (초기 재고 자체가 적었으므로)
- **2012-2016 (1차 반감기 후)**: 블록당 25 BTC, S2F ≈ 10
- **2016-2020 (2차 반감기 후)**: 블록당 12.5 BTC, S2F ≈ 25
- **2020-2024 (3차 반감기 후)**: 블록당 6.25 BTC, S2F ≈ 56 (금과 유사)
- **2024-2028 (4차 반감기 후)**: 블록당 3.125 BTC, S2F ≈ 120 (금을 초과)
...
- [건전화폐](/ko/ideas/sound-money/) — 가치 저장 기능이 훼손되지 않는 화폐의 이상
- [법정화폐](/ko/ideas/fiat-money/) — 정부 명령에 의해 강제 통용되는 화폐
- [반감기](/ko/ideas/halving/) — 비트코인의 신규 발행량을 주기적으로 절반으로 줄여 경도를 높이는 메커니즘
- [시간선호](/ko/ideas/time-preference/) — 현재 소비와 미래 소비 사이의 선호 비율
