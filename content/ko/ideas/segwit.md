...
- [노드](/ideas/node/) — UASF를 통해 세그윗 활성화를 주도한 비트코인 네트워크의 독립적 검증 소프트웨어
- [머클 트리](/ideas/merkle-tree/) — 세그윗이 증인 데이터를 위한 별도의 머클 구조를 도입
- [멤풀](/ideas/mempool/) — 세그윗의 가중치 시스템이 수수료 구조에 영향
