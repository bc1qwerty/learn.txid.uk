...
- **[칼 멩거](/ko/people/carl-menger/)** (오스트리아) — *"국민경제학 원리"*
...
비트코인의 공급량은 2,100만 개로 고정되어 있으며, [반감기](/ko/ideas/halving/)를 통해 새 공급이 계속 줄어듭니다. 반면 비트코인에 대한 수요(사용자, 거래량, 기관 채택)는 증가하는 추세입니다.

[법정화폐](/ko/ideas/fiat-money/)의 경우, 새로운 화폐 단위의 한계효용은 계속 발행되면서 체감합니다 — 이것이 인플레이션의 본질입니다. 비트코인은 추가 공급이 점점 줄어드는 구조이므로, 수요가 일정하다면 각 한계 단위의 희소성과 가치가 유지되거나 상승합니다.

이것이 비트코인이 [건전화폐](/ko/ideas/sound-money/)로서 기능할 수 있는 경제학적 근거 중 하나입니다.

## 연결되는 개념

- [주관적 가치론](/ko/ideas/subjective-value/) — 한계효용의 이론적 기초
- [건전화폐](/ko/ideas/sound-money/) — 화폐의 한계효용이 유지되는 조건
- [시간선호](/ko/ideas/time-preference/) — 현재의 한계효용과 미래의 한계효용 사이의 선호
- [오스트리아 경제학이란?](/ko/start/austrian-economics/) — 한계효용 이론의 학문적 배경
