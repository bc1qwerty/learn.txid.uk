...
이 개념은 원래 보험업계에서 비롯되었지만, 현대 금융 시스템과 정부 정책을 이해하는 데 핵심적인 도구입니다. 특히 오스트리아 경제학의 관점에서 도덕적 해이는 [법정화폐](/ko/ideas/fiat-money/) 시스템이 만들어내는 가장 파괴적인 인센티브 왜곡 중 하나입니다.
...
2008년 이후 대형 은행들은 오히려 더 커졌습니다. 규제가 강화되었지만, 근본 구조 — 이익은 사유화하고 손실은 사회화하는 구조 — 는 변하지 않았습니다. [경기변동이론](/ko/ideas/abct/)이 설명하는 호황-불황 사이클의 근저에 이 도덕적 해이가 있습니다.
...
- [경기변동이론](/ko/ideas/abct/) — 도덕적 해이가 만들어내는 호황-불황 사이클
- [법정화폐](/ko/ideas/fiat-money/) — 도덕적 해이를 가능하게 하는 화폐 시스템
- [칸티용 효과](/ko/ideas/cantillon-effect/) — 구제금융과 화폐 발행이 만드는 불공정한 부의 재분배
- [건전화폐](/ko/ideas/sound-money/) — 도덕적 해이를 구조적으로 억제하는 화폐의 속성
