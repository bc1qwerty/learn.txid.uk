...
- **왜 빈부격차가 확대되는가?** — [법정화폐](/ko/ideas/fiat-money/) 시스템 자체가 구조적으로 부를 상향 재분배
...
- **발행 규칙이 투명**: 비트코인의 새로운 공급은 [작업증명](/ko/ideas/proof-of-work/)을 통해 예측 가능하고 투명하게 이루어집니다
...
- [법정화폐](/ko/ideas/fiat-money/) — 칸티용 효과가 작동하는 토대
- [건전화폐](/ko/ideas/sound-money/) — 칸티용 효과를 제거하는 화폐의 속성
- [경기변동이론](/ko/ideas/abct/) — 칸티용 효과와 함께 작동하는 인위적 경기변동의 메커니즘
- [도덕적 해이](/ko/ideas/moral-hazard/) — 칸티용 효과가 만들어내는 제도적 무책임
