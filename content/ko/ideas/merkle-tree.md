...
- [작업증명](/ko/ideas/proof-of-work/) — 머클 루트를 포함한 블록 헤더를 해싱하여 블록을 생성하는 합의 메커니즘
- [노드](/ko/ideas/node/) — 머클 트리를 활용하여 트랜잭션의 무결성을 검증하는 네트워크 참여자
- [세그윗](/ko/ideas/segwit/) — 증인 데이터를 위한 별도의 머클 트리를 도입한 프로토콜 업그레이드
