---
title: "백업과 상속 계획 (Backup & Inheritance)"
description: "시드 문구를 안전하게 보관하고, 소유자 사망·무능력 시 자산을 전달하는 전략. 비트코인 자기주권의 마지막 퍼즐."
tags: ["비트코인"]
levels: "상급"
weight: 40
---
...
1. **신뢰할 수 있는 사람 지정**: 시드 문구 접근법을 전달할 대상 (배우자, 자녀, 변호사)
2. **정보 분리 원칙**: 한 사람에게 모든 정보를 주지 않는다
   - A에게: 시드 문구의 위치
   - B에게: 패스프레이즈
   - C에게: 복구 절차 안내서
3. **[멀티시그](/ko/ideas/multisig/) 활용**: 2-of-3 설정으로 유족 2인이 합의하면 자금 이동 가능
...
- [비트코인 지갑 완벽 가이드](/ko/ideas/wallet-guide/) — 지갑 종류별 보안 특성과 선택 가이드
- [멀티시그](/ko/ideas/multisig/) — 다중 서명으로 단일 장애점을 제거하는 보안
- [노드](/ko/ideas/node/) — 자신의 거래를 제3자 없이 직접 검증
