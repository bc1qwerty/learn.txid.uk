...
2. **정보 분리 원칙**: 한 사람에게 모든 정보를 주지 않는다
   ...
   - B에게: 패스프레이즈
   - C에게: 복구 절차 안내서
3. **[멀티시그](/ideas/multisig/) 활용**: 2-of-3 설정으로 유족 2인이 합의하면 자금 이동 가능
...
- [비트코인 지갑 완벽 가이드](/ideas/wallet-guide/) — 지갑 종류별 보안 특성과 선택 가이드
- [멀티시그](/ideas/multisig/) — 다중 서명으로 단일 장애점을 제거하는 보안
- [노드](/ideas/node/) — 자신의 거래를 제3자 없이 직접 검증
