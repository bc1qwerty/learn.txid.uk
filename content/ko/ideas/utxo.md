...
- [비트코인 지갑 완벽 가이드](/ideas/wallet-guide/) — UTXO를 실제로 관리하는 도구
- [멀티시그](/ideas/multisig/) — 다중 서명으로 UTXO의 보안을 강화
- [세그윗](/ideas/segwit/) — 서명 데이터를 분리하여 UTXO 처리 효율을 개선
- [라이트닝 네트워크](/ideas/lightning-network/) — UTXO를 기반으로 한 오프체인 결제 채널
