...
작업증명이 필요한 가장 근본적인 이유는 **이중 지불(Double-Spend) 문제**를 해결하기 위해서다.
...
이것이 작업증명의 경제적 보안이다. 규칙을 어기는 것보다 지키는 것이 경제적으로 더 유리하게 설계되어 있다.
...
작업증명은 단순한 기술적 선택이 아니다. 신뢰 없이 합의에 도달하는 탈중앙화 디지털 화폐를 가능하게 하는 유일하게 검증된 메커니즘이다. 그 에너지 비용은 인류 역사상 처음으로 국가 없이 작동하는 글로벌 화폐 시스템의 운영 비용이라고 볼 수 있다.
