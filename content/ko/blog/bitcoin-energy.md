...
{{< chart-bar title="연간 에너지 소비 비교 (TWh)" labels="비트코인,전통 금융,금 채굴,데이터센터" values="150,260,240,200" unit="TWh" color="bitcoin" >}}
...
[작업증명](/ko/ideas/proof-of-work/)은 거래 처리가 아니다. 시가총액 1조 달러 이상의 가치를 지키는 보안 체계다. 네트워크를 공격하려면 정직한 채굴자들이 쓰는 것보다 더 많은 에너지가 필요하다. 물리 법칙이 비트코인을 보호한다.
...
어떤 에너지 사용이 "가치 있는지"를 정부나 언론이 판단해야 한다는 주장은, [자생적 질서](/ko/ideas/spontaneous-order/)를 부정하고 중앙계획을 지지하는 것과 같다. "낭비가 아닌" 에너지 사용 목록을 누가 만들 건가. [경제계산 문제](/ko/ideas/economic-calculation/)와 직결되는 이야기다. 수억 명의 필요와 가치를 어떤 기관도 대신 판단할 수 없다.
...
비트코인은 에너지를 쓴다. 맞다. 인류 역사상 가장 안전한 화폐 시스템을 유지하는 비용이다. [법정화폐](/ko/ideas/fiat-money/) 시스템이 전 세계에 부과하는 비용에 비하면, 전 세계 에너지의 0.1%는 싸다.
