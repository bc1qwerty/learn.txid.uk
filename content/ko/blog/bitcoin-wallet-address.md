...
비트코인을 처음 접하면 긴 문자열로 이루어진 주소 앞에서 당혹감을 느끼기 쉽다. `1A1zP1eP5QGefi2DMPTfTL5SLmv7Divf`Na 같은 문자열은 무슨 의미이며, 어떻게 생성되고, 왜 이렇게 복잡한 형태를 가지는가. 이 글은 그 질문에 답한다.
...
주소와 [트랜잭션 ID(TXID)](/ko/blog/bitcoin-wallets/)는 혼동하기 쉽지만 전혀 다른 개념이다.
...
## mempool.space로 주소 검증하기

주소가 유효한지, 잔액이 얼마인지 직접 확인하려면 [mempool.space](https://mempool.space/)를 활용하면 된다.

**실습 순서:**

1. mempool.space 접속 후 검색창에 비트코인 주소 입력

![mempool.space 주소 검색 화면](/images/learn/address-validation-1.webp)
