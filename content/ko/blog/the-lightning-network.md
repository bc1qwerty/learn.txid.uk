...
**확장성**: 라이트닝 네트워크는 이론적으로 초당 수백만 건의 거래를 처리할 수 있다. 비자의 초당 최대 처리 건수가 약 24,000건인데, 라이트닝은 이를 훨씬 초과하는 규모의 거래를 감당할 수 있다.
...
**사용자 경험.** 일반 사용자가 라이트닝을 사용하려면 여전히 기술적 이해가 어느 정도 필요하다. Phoenix, Muun 같은 모바일 지갑들이 이 진입 장벽을 낮추고 있지만, 전통적인 결제 앱만큼 직관적이지는 않다.
