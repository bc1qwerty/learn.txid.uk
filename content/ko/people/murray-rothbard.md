...
출발점은 **[자기 소유권](/ko/ideas/self-ownership/)(self-ownership)**: 모든 사람은 자기 자신의 몸에 대한 절대적인 소유권을 가집니다. 이로부터 다음이 논리적으로 도출됩니다:

1. 자기 몸의 노동으로 무주물(unowned resources)을 변형하면, 그것에 대한 **정당한 소유권**이 발생합니다(개간, homesteading)
2. 정당하게 소유한 재산은 **자발적 교환**을 통해서만 이전될 수 있습니다
3. 타인의 신체나 정당하게 취득한 재산에 대한 **강제력 행사는 부당**합니다([비침해 원칙](/ko/ideas/non-aggression-principle/))
...
이것은 단순한 "작은 정부"가 아닙니다. 로스바드는 미제스와 하이에크가 받아들인 [최소 국가(minarchy)](/ko/ideas/minarchy/)조차 비침해 원칙에 위배된다고 보았습니다. 세금에 의해 운영되는 모든 정부는 그 크기와 관계없이 강제력에 기반합니다.
...
- [비침해 원칙](/ko/ideas/non-aggression-principle/) — 로스바드 윤리학의 핵심
- [건전화폐](/ko/ideas/sound-money/) — 로스바드가 옹호한 화폐 원칙
- [오스트리아 경기변동이론](/ko/ideas/abct/) — 로스바드가 대공황에 적용한 이론
- [자유주의란?](/ko/start/libertarianism/) — 로스바드가 체계화한 정치철학
