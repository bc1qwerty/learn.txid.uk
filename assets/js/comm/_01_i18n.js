  ...
  const T = {
    ko: {
      ...
      nip05_sats: 'sats/년', nip05_invalid: '5-16자, 영소문자/숫자/하이픈',
      ...
      nip05_premium_link: '프리미엄 유저네임(1~4자)은 <a href="https://id.txid.uk" target="_blank" rel="noopener" class="text-purple-400 hover:text-purple-300 underline">id.txid.uk</a>에서 등록',
    },
    en: {
      ...
      nip05_sats: 'sats/year', nip05_invalid: '5-16 chars, lowercase/numbers/hyphens',
      ...
      nip05_premium_link: 'Premium usernames (1-4 chars) at <a href="https://id.txid.uk" target="_blank" rel="noopener" class="text-purple-400 hover:text-purple-300 underline">id.txid.uk</a>',
    },
    ja: {
      ...
      nip05_sats: 'sats/年', nip05_invalid: '5-16文字、小文字/数字/ハイフン',
      ...
      nip05_premium_link: 'プレミアムユーザー名(1〜4文字)は<a href="https://id.txid.uk" target="_blank" rel="noopener" class="text-purple-400 hover:text-purple-300 underline">id.txid.uk</a>で登録',
    },
  };
